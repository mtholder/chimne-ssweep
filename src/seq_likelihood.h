...
#include "cPhyProb/ccore/cphyprob.h"


#if defined (USE_BEAGLE_LIB)

#	include "cPhyProb/ccore/from_ncl_factory.h"
	...
	*/
	LikeStructsBundle newLikeStructs(const NxsCDiscreteMatrix matrix, unsigned nPartials, unsigned nPMats, unsigned nRates);
